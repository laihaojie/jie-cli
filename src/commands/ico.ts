...
export async function imgToIco(image_path: string, options: ImageToIcoOptions) {
...
function handleIco(buffer, inputPath, options) {
  console.log(buffer, inputPath, options)
}
